...
function cargarDatos(){
    ...
    $.each(nuevoEmpleado, function( index, empleado ) {
 			...
 			$("#tabla1 tbody").append('<tr>' + 
    			 ...
    			 '<td align="center" style="dislay:none; id="'+ids+'">' + '<input style="display:block" type="button" class="eliminar'+ids+'" value="Eliminar" onclick="Eliminar('+ids+')" id="'+ids+'">' + '<input style="display:none" type="button" class="cancelar'+ids+'" value="Cancelar" onclick="Cancelar('+ids+')" id="'+ids+'">'+  '</td>'+
...
function cargarDatosFiltro(){
 ...
 $("#tabla1 tbody").remove(); 
    ...
    nuevoEmpleado1 = indez.slice(Pagina, Pagina+registrosPaginas);
