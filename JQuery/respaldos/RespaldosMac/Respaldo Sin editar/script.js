...
function cargarDatos(){
    ...
    $.each(nuevoEmpleado, function( index, empleado ) {
 			...
 			$("#tabla1 tbody").append('<tr>' + 
    			 ...
    			 '<td data-nombre="'+ids+'" align="center" style="dislay:none; id="'+ids+'">' + empleado.Nombre + '</td>'+
    			 '<td data-ApP="'+ids+'" align="center" style="dislay:none; id="'+ids+'">' + empleado.ApellidoPaterno + '</td>'+
    			 '<td data-ApM="'+ids+'" align="center" style="dislay:none; id="'+ids+'">' + empleado.ApellidoMaterno + '</td>'+
    			 '<td data-Edad="'+ids+'" align="center" style="dislay:none; id="'+ids+'">' + empleado.Edad + '</td>'+
